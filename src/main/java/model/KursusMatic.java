...
public class KursusMatic extends KursusMengemudi {
    ...
    public KursusMatic(int idPendaftaran, String namaSiswa, String noTelepon, int jumlahPertemuan, double tarifPerPertemuan, boolean butuhSertifikat, double biayaSertifikat) {
...
@Override
    public void tampilkanInfo() {
        super.tampilkanInfo();
        System.out.println("Tipe Kursus          : Mobil Matic");
